...
def main():
    ...
    side_bar = st.sidebar
    image_file = side_bar.file_uploader('Upload an image', type=['png', 'jpg', 'jpeg'])  # Added label 'Upload an image'
    ...
    if image_file is not None:
        ...
        if start_btn:
            ...
            annoted_image = utlis.annotate_image(image.copy(), result)  # Make sure the image is writable
